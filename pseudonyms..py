# -*- coding: utf-8 -*-
"""
Created on Sun Dec 20 21:51:33 2020
...
middle = ('Kingfish', 'Listenbee', "M'Bembo", 'McFadden', 'Moonshine', 'Nettles',
            'Roseworthy', 'Olivetti', 'Outerbridge', 'peck', 'Overturf',
            'Oxhandler', 'Pealike', 'Pennywhistle', 'Peterson', 'Pieplow',
            'Dinkerton', 'Porkins', 'Putney', 'Quakenbush', 'water',
            'Rosenthal', 'Ruboff', 'rider', 'shine', 'Splern',
            'Vtevens', 'Stroga')
